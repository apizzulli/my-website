    ...
    return(
        <div className="about-me-page">
            ...
            <div className="intro-flexbox">
                ...
                <br></br>
                <p style={{fontSize:'15pt'}}>My name is Anthony and I'm currently a Software Development Engineer
                    at Publicis Sapient. <br></br><br></br>
            ...
            <div style={{fontSize: '12pt',marginTop: '3%',width:'65vw', marginLeft: 'auto', marginRight: 'auto'}}>
            </div>
            <div className='footer-flexbox'>
                ...
                <div>
                <img style={{marginLeft: '2%',width:'250px', height:'125px'}}src={ps}></img>
                </div>
                <div></div>
            </div>
        </div>
