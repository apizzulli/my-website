    ...
    return(
        <div class = 'body' >
            <div class = 'body-text'>
                ...
                <div style={{backgroundColor:'rgba(43, 48, 53, .7)',borderRadius:'3px',paddingTop:'4%',paddingBottom:'4%',paddingLeft:'4%',paddingRight:'4%',fontSize:'14pt'}}>Welcome!<br></br>I'm Anthony, & this is the home page for my personal site.<br></br> <br></br>
